...
8. Copy all of the resources from the `resources` folder to the APK's `assets` folder.
9. In the `smali` folder of the APK, open the `GeometryJump.smali` file. Find where it says something like:
